...
import com.alkaid.yygh.order.utils.ConstantPropertiesUtils;
import com.alkaid.yygh.order.utils.HttpClient;
...
public class WeixinServiceImpl implements WeixinService {
    ...
    public Map createNative(Long orderId) {
        ...
        try {
            ...
            paramMap.put("total_fee", "1");  //测试使用，统一0.00
